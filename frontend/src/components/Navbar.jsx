                        ...
                        {navItems .map(item=>(
                            ...
                            ${activeTab===item.path ?
                                ...
                                <div className='flex items-center'>
                                    ...
                                    ${activeTab===item.path ? navbarStyles.activeNavIcon : navbarStyles.inactiveNavIcon}`}>
                                        {item.icon}
                                    </span>
                                    <span>{item.name}</span>
                                </div>
                        ...
                        <div className={navbarStyles.mobileButtons}>
                            {isLoggedIn ? (
                                ...
                                className={navbarStyles.loginButton}>
                                    <FiUser className={navbarStyles.loginButtonIcon}></FiUser>
                                    Logout
                                </button>
                            ) : (
                                <Link to='/login' className={navbarStyles.loginButton} onClick={()=> setIsOpen(false)}>
                                    <FiUser className={navbarStyles.loginButton}></FiUser>
                                    Login
                                </Link>
                            )}
                        </div>
