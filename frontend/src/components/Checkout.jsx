      ...
      <div className={checkoutStyles.container}>
        ...
        <div className={checkoutStyles.header}>
          ...
          <p className={checkoutStyles.subtitle}>
            Complete your purchases wih secure checkout
          </p>
        </div>
              ...
              <div>
                ...
                <label className={checkoutStyles.radioCard}>
                  <input type="radio" name='paymentMethod' value='COD' checked={formData.paymentMethod === 'COD'}
                    onChange={handleChange} className='h-5 w-5 text-emerald-600 focus:ring-emerald-500' />
                  <div className='ml-3'>
                ...
                <label className={checkoutStyles.radioCard}>
                  <input type="radio" name='paymentMethod' value='Online' checked={formData.paymentMethod === 'Online'}
                    onChange={handleChange} className='h-5 w-5 text-emerald-600 focus:ring-emerald-500' />
                  <div className='ml-3'>
                    <span className='font-medium text-emerald-100'>
                      Online Delivery
                    ...
                    <div className={checkoutStyles.cartImage}>
                      {item.imageUrl ? (
                        <img src={`http://localhost:4000${item.imageUrl}`} alt={item.name}
                          ...
                          onError={e => {
                            e.target.onerrpr = null;
                            e.target.sec = '/no-image.png';
                          }} />
                      ) : (
