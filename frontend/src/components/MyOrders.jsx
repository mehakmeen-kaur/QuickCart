...
import { FiArrowLeft, FiCreditCard, FiMail, FiMapPin, FiPackage, FiPhone, FiSearch, FiTruck, FiUser, FiX } from 'react-icons/fi'
        ...
        <div className={ordersPageStyles.searchContainer}>
          <div className={ordersPageStyles.searchForm}>
            <input type="text" placeholder='Search orders or products...'
              className={ordersPageStyles.searchInput} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
          ...
          <div className={ordersPageStyles.modalContainer}>
                ...
                <div>
                    ...
                    <div className={ordersPageStyles.modalCard}>
                      <div className='mb-3'>
                        ...
                        <div className='text-emerald-300 flex items-center mt-2'>
                          ...
                          {selectedOrder.customer.phone || 'No email found'}
                        </div>
                      </div>
                  ...
                  {selectedOrder.notes && (
                    <div className={ordersPageStyles.modalSection}>
                      ...
                      <div className='bg-eme/50 border-l-4 border-emerald-400 p-4 rounded-lg'>
                ...
                <div>
                  ...
                  <div>
                    <div className={ordersPageStyles.modalSection}>
                      ...
                      <div className='border border-emerald-700 rouonded-xl overflow-hidden'>
                        {selectedOrder.items.map((item, index) => (
                          <div key={item._id || idx}
                            ...
                            {item.imageUrl ? (
                              ...
                              <div className='bg-emerald-800 border-2 border-dashed border-emerald-700 rounded-xl w-16 h-16
                            ...
                            <div className='font-medium text-emerald-100'>₹{(item.price * item.quantity).toFixed(2)}</div>
                          </div>
                        ))}
                    ...
                    <div>
                      ...
                      <div className={ordersPageStyles.modalCard}>
                        ...
                        <div className='flex justify-between'>
                          ...
                          <span className={`px-2 rounded-full text-xs font-medium ${selectedOrder.paymentStatus==='Paid' ? 'bg-emerald-500/20 text-emerald-200':'bg-red-500/20 text-red-200'}`}>
            ...
            <div className={ordersPageStyles.modalFooter}>
              <div className='flex justify-end'>
                ...
                className={ordersPageStyles.closeButton}>Close</button>
              </div>
            </div>
          </div>
        </div>
